<?php 
/* Template Name: Cybersecurity Report */
        ...
        $str .= '<table style="width: 100%;">';
            $str .= '<tr>';
                ...
                $str .= '<td style="vertical-align: top;width:250px;padding-bottom:0;">';
                    ...
                    $str .= '<p style="margin-top:5px;font-size:14px;">Cybersecurity Executive Summary</p>';
                    $str .= '<p style="margin-top:5px;font-size:14px;">'.$data['date'].'</p>';
                    $str .= '<div style="margin-left:150px;text-align:center;width:100px;">';
                        $str .= '<p style="font-size:12px;color:000;">Function Average:</p>';
                ...
                $str .= '<td class="'.($data['function']['bg'] ? $data['function']['bg'] : '').'" style="border-left: 0;vertical-align:top;color:#fff;">';
                    $str .= '<p style="font-size:18px;font-weight:700;margin-bottom:5px;">Function: '.($data['function']['name'] ? $data['function']['name'] : '').'</p>';
