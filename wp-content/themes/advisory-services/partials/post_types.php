...
function advisory_init() {
	...
	register_post_type('facility', array(
		'labels' => array(
			'name' => _x('Facility Risk', 'post type general name', 'advisory'),
			'singular_name' => _x('Facility Risk', 'post type singular name', 'advisory'),
			'menu_name' => _x('Facility Risk', 'admin menu', 'advisory'),
			'name_admin_bar' => _x('Risk', 'add new on admin bar', 'advisory'),
			'add_new' => _x('Add New', 'facility', 'advisory'),
			'add_new_item' => __('Add New Risk', 'advisory'),
			'new_item' => __('New Risk', 'advisory'),
			'edit_item' => __('Edit Risk', 'advisory'),
			'view_item' => __('View Risk', 'advisory'),
	...
	register_post_type('cma', array(
		'labels' => array(
			'name' => _x('Cloud Maturity', 'post type general name', 'advisory'),
			'singular_name' => _x('Cloud Maturity', 'post type singular name', 'advisory'),
			'menu_name' => _x('Cloud Maturity', 'admin menu', 'advisory'),
			'name_admin_bar' => _x('Cloud Maturity', 'add new on admin bar', 'advisory'),
			'add_new' => _x('Add New', 'Cloud Vendor', 'advisory'),
			'add_new_item' => __('Add New Cloud Maturity', 'advisory'),
			'new_item' => __('New Cloud Maturity', 'advisory'),
			'edit_item' => __('Edit Cloud Maturity', 'advisory'),
			'view_item' => __('View Cloud Maturity', 'advisory'),
			'all_items' => __('All Cloud Maturity', 'advisory'),
			'search_items' => __('Search Cloud Maturity', 'advisory'),
			'parent_item_colon' => __('Parent Cloud Maturity:', 'advisory'),
			'not_found' => __('No Cloud Maturity found.', 'advisory'),
			'not_found_in_trash' => __('No Cloud Maturity found in Trash.', 'advisory'),
		),
		'public' => true,
		'exclude_from_search' => true,
		'supports' => array('title'),
	...
	register_post_type('csma', array(
		'labels' => array(
			'name' => _x('Cybersecurity Maturity', 'post type general name', 'advisory'),
			'singular_name' => _x('Cybersecurity Maturity', 'post type singular name', 'advisory'),
			'menu_name' => _x('Cybersecurity Maturity', 'admin menu', 'advisory'),
			'name_admin_bar' => _x('Cybersecurity Maturity', 'add new on admin bar', 'advisory'),
			'add_new' => _x('Add New', 'Cybersecurity Vendor', 'advisory'),
			'add_new_item' => __('Add New Cybersecurity Maturity', 'advisory'),
			'new_item' => __('New Cybersecurity Maturity', 'advisory'),
			'edit_item' => __('Edit Cybersecurity Maturity', 'advisory'),
			'view_item' => __('View Cybersecurity Maturity', 'advisory'),
			'all_items' => __('All Cybersecurity Maturity', 'advisory'),
			'search_items' => __('Search Cybersecurity Maturity', 'advisory'),
			'parent_item_colon' => __('Parent Cybersecurity Maturity:', 'advisory'),
			'not_found' => __('No Cybersecurity Maturity found.', 'advisory'),
			'not_found_in_trash' => __('No Cybersecurity Maturity found in Trash.', 'advisory'),
		),
		'public' => true,
		'exclude_from_search' => true,
		'supports' => array('title'),
