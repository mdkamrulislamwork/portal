...
<div class="content-wrapper">
    ...
    if ($select_attr == '') {
        ...
        $summary_2 = !empty($pdfdefault['summary_2']) ? $pdfdefault['summary_2'] : '';
        echo '<div class="row">';
            echo '<div class="col-md-12">';
                echo '<form class="sfiats-form single" method="post" data-meta="pdf" data-id="'.$transient_post_id.'">';
                    ...
                    echo '</div>';
                    echo '<div class="card">';
                        echo '<div class="card-title-w-btn"> <h4 class="title">Summary 2</h4> </div>';
                        echo '<div class="card-body"><textarea name="summary_2" class="tinymce-editor">'.$summary_2.'</textarea></div>';
                        echo '<div class="card-footer text-right"><button class="btn btn-success" type="submit"><i class="fa fa-lg fa-floppy-o"></i> Save</button></div>';
                    echo '</div>';
                echo '</form>';
            echo '</div>';
