                        ...
                        echo '<div class="col-md-8">';
                            echo '<div class="card">';
                                echo '<div class="card-title-w-btn">';
                                    echo '<h4 class="title" style="background-color: #0c0c0c;color: #f9f9f9;padding: 10px 150px 10px 5px;">Section '.$areaSi.': '. @$area['name'] .'</h4>';
                                        ...
                                        if ( !empty($opts[$threatId]) ) {
                                            echo '<div class="table-responsive">';
                                                 echo '<table class="table table-bordered">';
                                                    echo '<tr>';
                                                        echo '<td class="border-bottom-only" ><strong style="background-color: #a45000;color: #f9f9f9;padding: 10px 140px 10px 5px;">'.$threatCat['name'].'</strong></td>';
