			...
			'fields' => array(
				...
				array(
					...
					'fields' => [
						...
						['id' => 'tap_q1', 'type' => 'number', 'title' => 'TAP: Num Row for 1 (Team Action Plan)', 'default' => 1],
					],
				),
			),
		),
...
$options[] = [
	...
	'sections' => [
		...
		[
			...
			'title' => 'Threat Cats',
			'fields' => [
				['type' => 'notice', 'class' => 'danger', 'content' => 'Create Threat Cats and save. Then create Threats, and Questions'],
				[
					'id' => 'areas',
					'type' => 'group',
					'title' => 'Threat Cats',
		...
		['name' => 'threats', 'title' => 'Threats', 'fields' => advisory_generate_bcp_form_threats()],
		['name' => 'questions', 'title' => 'Questions', 'fields' => advisory_generate_bcp_form_questions()],
		['name' => 'tc_questions', 'title' => 'Thereat Cat Questions', 'fields' => advisory_generate_bcp_threat_questions()]
	]
];
// -----------------------------------------
...
$options[] = [
	...
	'sections' => [
		...
		[
			...
			'title' => 'Facilities',
			'fields' => [
				['type' => 'notice', 'class' => 'danger', 'content' => 'Create Facilities and save. Then create Threat cats, Statements and Questions'],
				[
					'id' => 'areas',
					'type' => 'group',
					'title' => 'Facilities',
		...
		['name' => 'threats', 'title' => 'Threat Cats', 'fields' => advisory_generate_facility_form_threats()],
		['name' => 'statements', 'title' => 'Statements', 'fields' => advisory_generate_facility_form_statements()],
		['name' => 'questions', 'title' => 'Statement Questions', 'fields' => advisory_generate_facility_form_questions()]
	]
];
// -----------------------------------------
...
$options[] = [
	...
	'sections' => [
		...
		['name' => 'threats', 'title' => 'Domains', 'fields' => cma_form_threatcats()],
		['name' => 'statements', 'title' => 'Questions', 'fields' => cma_form_statements()],
	]
];
// -----------------------------------------
...
$options[] = [
	...
	'sections' => [
		...
		['name' => 'threatcats', 'title' => 'Categories', 'fields' => csma_form_threatcats()],
...
$options[] = array(
	...
	'sections' => array(
		...
		array(
			'name' => 'threats',
			'title' => 'Threats',
			'fields' => advisory_generate_facility_form_threats(),
		),
	),
);
// -----------------------------------------
