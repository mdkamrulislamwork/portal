		                                ...
		                                <table class="table table-bordered table-survey mb-none">
		                                    <tbody>';
		                                        echo '<tr>';
		                                            ...
		                                            echo '<th colspan="2" class="t-heading-l-dark text-uppercase text-center font-110p">Analysis</th>';
		                                            echo '<th class="t-heading-l-dark text-uppercase text-center font-110p">Controls</th>';
		                                        echo '</tr>';
		                                        echo '<tr>';
		                                            ...
		                                            echo '<td rowspan="2" class="bigComment pointer" comment="'.htmlentities($PUCSummary).'"><img src="'. IMAGE_DIR_URL .'bcp/summary.png" class="img-responsive clickableIcon" alt="Summary" title="Summary">';
		                                            echo '</td>';
		                                            echo '<td rowspan="2" class="bigComment pointer" comment="'.htmlentities($PUCHistoricalEvidence).'"><img src="'. IMAGE_DIR_URL .'bcp/historical_evidence.png" class="img-responsive clickableIcon" alt="Historical Evidence" title="Historical Evidence">';
		                                            echo '</td>';
		                                            echo '<td rowspan="3" class="no-padding width-65p">';
		                                                echo '<textarea name="controls" rows="3" class="form-control" '.$permission['attr'].'>'.@$default['controls'].'</textarea>';
		                                            echo '</td>';
		                                        echo '</tr>';
		                                        echo '<tr>';
		                                ...
		                                <table class="table table-bordered table-survey">
		                                	<tbody>
		                                        ...
		                                        <tr>
		                                            ...
		                                            <td rowspan="2" class="no-padding angleContainer font-110p '.BCPcolorByValue($defaultVulnerability).'"><div class="angularArea"></div>' . advisory_opt_select('vulnerability', '', '', $permission['attr'], $volnerabilityOptions, $defaultVulnerability) . '</td>
													<td rowspan="2" class="no-padding angleContainer font-110p '.BCPcolorByValue($defaultImpact).'"><div class="angularArea"></div>' . advisory_opt_select('impact', '', '', $permission['attr'], $impactOptions, $defaultImpact) . '</td>
		                                            <td rowspan="2" class="no-padding angleContainer font-110p '.BCPcolorByValue($defaultProbablity).'"><div class="angularArea"></div>' . advisory_opt_select('probablity', '', '', $permission['attr'], $probablityOptions, $defaultProbablity) . '</td>
		                                        </tr>
		                                        <tr>
