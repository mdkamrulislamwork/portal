                ...
                $str .= '<div class="card-body">';
                    $str .= '<div class="table-responsive">';
                        $str .= '<table class="table table-csmaFunction">';
                            ...
                            $str .= '<td class="cloudVendorFuncAvg" style="text-align: center;"><h4 class="title" style="margin-bottom: 10px;"> Category Average: </h4><span style="padding: 8px 16px;border-radius: 3px;" data-toggle="tooltip" data-placement="left" title=""></span></td>';
                            $str .= '</tr>';
                        $str .= '</table>';
                    $str .= '</div>';
                $str .= '</div>';
                        ...
                        $str .= '<div class="card">';
                            $str .= '<div class="table-responsive mb-10">';
                                $str .= '<table>';
                                    ...
                                    $str .= '</td>';
                                    $str .= '<td class="cloudVendorCatAvg" style="text-align: center;">';
                                        $str .= '<h4 class="title" style="margin-bottom: 3px;"> Control Domain Average: </h4>';
                                        $str .= '<span style="padding: 5px 11px;border-radius: 2px;font-size: 14px;display: inline-block;" class="'.$catAvgStatus['cls'].'" data-toggle="tooltip" data-placement="left" title="'.$catAvg.'">'.$catAvgStatus['text'].'</span>';
                                                        ...
                                                        <thead>';
                                                            $str .= '<tr class="controlStatementRating">';
                                                                $str .= '<td colspan="5" class="no-border pl-0">';
                                                                    ...
                                                                    $str .= '<strong><big>Maturity Rating: </big> <span class="cloudVendorControlStatementAvgStatus '.$controlStatementAvgStatus['cls'].'" data-toggle="tooltip" data-placement="right" title="'.$controlStatementAvg.'" style="padding: 4px 5px;border-radius: 2px;font-size: 12px;"> '.$controlStatementAvgStatus['text'].' </span></strong>';
