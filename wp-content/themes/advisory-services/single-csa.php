...
?>
                            ...
                            <div class="card">
                                ...
                                echo '<div class="card-body">';
                                    if ($permission['edit']) {
                                        ...
                                        echo '<div class="form-group"> <h4 class="title">RISK Title : </h4> <div class="form-control font-130p">'. @$intro['risk'] .'</div> </div>';
                                    }
                                    echo '<br>';
                                    if ($permission['edit']) {
                                        $editor_id = 'cyberc';
                                        ...
                                        echo '<div class="form-group"> <h4 class="title">CYBERSECURITY Title : </h4> <div class="form-control font-130p">'. @$intro['cyberc'] .'</div> </div>';
                                    }
                                        ...
                                        <div class="card">
                                            ...
                                            echo '<div class="card-body">';
                                                echo '<div class="form-group">
                                                    ...
                                                    <input class="form-control font-130p" type="text" name="at" id="at" ' . $permission['attr'] . ' value="'. @$pdf['at'] .'">
                                                </div>';
                                                if ($permission['edit']) {
                                                    echo '<div class="form-group"> <h4 class="title">Assessment Desc : </h4> <textarea class="form-control font-130p texarea" name="ad" id="ad" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['ad'] .'</textarea> </div>';
                                                } else {
                                                    $editor_id = 'ad';
                                                ...
                                                echo '<div class="form-group">
                                                    ...
                                                    <input class="form-control font-130p" type="text" name="st" id="st" ' . $permission['attr'] . ' value="'. @$pdf['st'] .'">
                                                </div>';
                                                if ($permission['edit']) {
                                                    echo '<div class="form-group"> <h4 class="title">Summary Desc : </h4> <textarea class="form-control font-130p" name="sd" id="sd" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['sd'] .'d</textarea> </div>';
                                                } else {
                                                    $editor_id = 'sd';
                                                    $content = @$pdf[$editor_id];
                                                    $editor['textarea_name'] = $editor_id;
                                                ...
                                                echo '<div class="form-group">
                                                    ...
                                                    <textarea class="form-control font-130p" name="pa" id="pa" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['pa'] .'</textarea>
                                                </div>';
                                            echo '</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            echo '<div class="card-body">';
                                                ...
                                                if ($permission['edit']) {
                                                    echo '<div class="form-group"> <h4 class="title">Assessment Desc : </h4> <textarea class="form-control font-130p" name="ad" id="ad" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['ad'] .'</textarea> </div>';
                                                } else {
                                                    $editor_id = 'ad';
                                                    $content = @$pdf[$editor_id];
                                                    $editor['textarea_name'] = $editor_id;
                                                ...
                                                if ($permission['edit']) {
                                                    echo '<div class="form-group"> <h4 class="title">Summary Desc : </h4> <textarea class="form-control font-130p" name="sd" id="sd" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['sd'] .'</textarea> </div>';
                                                } else {
                                                    $editor_id = 'sd';
                                                    $content = @$pdf[$editor_id];
                                                    $editor['textarea_name'] = $editor_id;
                                                ...
                                                echo '<div class="form-group">
                                                    <h4 class="title">Process Areas : </h4>
                                                    <textarea class="form-control font-130p" name="pa" id="sinesdfkjdfpa" cols="30" rows="2" ' . $permission['attr'] . '>'. @$pdf['pa'] .'</textarea>
                                                </div>';
                                            echo '</div>';
                                            echo '<div class="card-footer text-right">';
                                                if ($permission['edit']) {
    ...
    echo '<div id="modal-csa" class="modal fade">';
        echo '<div class="modal-dialog" style="overflow:hidden">';
            echo '<div class="modal-content">';
                ...
                echo '<div class="row modal-footer">';
                    ...
                    if ($permission['edit']) echo '<label> <input style="float: left;width: 20px;" type="checkbox" id="areaSelect"> Select this area </label>';
                    echo '</div>';
                    echo '<div class="col-sm-6">';
                        echo '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
                        if ($permission['edit']) echo '<button type="button" class="btn btn-primary saveCSA">Save changes</button>';
                    echo '</div>';
                echo '</div>';
            echo '</div>';
        echo '</div>';
