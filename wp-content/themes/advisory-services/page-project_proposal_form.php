            ...
            <form class="projectProposalForm" method="post" data-id="<?php echo $companyId;?>">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <table><tr><td style="width: 120px;">Project Name:</td> <td><input type="text" name="project_name" style="width: 100%;" value="<?php echo @$default->project_name; ?>"></td></tr></table>
                            </div>
                        ...
                        <div class="row mt-20">
                            <div class="col-sm-3">
                                ...
                                <table class="table table-borderless m-0">
                                    <tr>
                                        <td style="width: 75px;"><small>Operating:</small></td>
                                        <td><input name="operating" type="text" style="width: 100%" value="<?php echo @$default->operating; ?>"></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 75px;"><small>Capital:</small></td>
