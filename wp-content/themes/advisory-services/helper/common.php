...
function commentModal($size="modal-lg")
{
	$str = null;
	$str .= '<div class="modal fade" id="commentModal">';
    	$str .= '<div class="modal-dialog '.$size.'">';
        	$str .= '<div class="modal-content modal-inverse">';
            	$str .= '<div class="modal-header">';
                	$str .= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                	$str .= '<h4 class="modal-title">Comment</h4>';
            	$str .= '</div>';
...
function editableCommentModal($size="modal-lg")
{
	$str = null;
	$str .= '<div class="modal fade" id="commentModal">';
    	$str .= '<div class="modal-dialog '.$size.'">';
        	$str .= '<div class="modal-content modal-inverse">';
            	...
            	$str .= '<div class="modal-footer">';
                	$str .= '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>';
                	$str .= '<button type="button" class="btn btn-primary hidden editBtn">Edit</button>';
                	$str .= '<button type="button" class="btn btn-primary hidden saveBtn">Save changes</button>';
            	$str .= '</div>';
        	$str .= '</div>';
    	$str .= '</div>';
	$str .= '</div>';
...
function viewCommentModal($size="modal-lg")
{
	$str = null;
	$str .= '<div class="modal fade" id="viewCommentModal">';
    	$str .= '<div class="modal-dialog '.$size.'">';
        	$str .= '<div class="modal-content modal-inverse">';
            	$str .= '<div class="modal-header">';
                	$str .= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
