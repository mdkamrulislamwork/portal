...
if (empty($post_id)) echo '<p>'. __('SFIA Not Available Yet') .'</p>';
    ...
    // unset($active_users[3]['HW024']); update_post_meta( $post_id, 'active_users', $active_users);
    ...
    <div class="page-title" style="padding-bottom: 5px;">
        ...
        <?php if ($select_attr == '') { 
            echo '<div>';
                ...
                echo ' <a class="btn btn-lg btn-success btn-pdf-preview" target="_blank" href="javascript:;" disabled>Report Preview</a>';
            echo '</div>';
        } ?>
        <div>
            <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form class="survey-form" method="post" data-meta="head" data-id="<?php echo $post_id ?>">
                <div class="card">
                    <div class="card-body sfia-wrapper single-sfia-wrapper">
                        <div class="sfia-header">
                            <div class="row">
                                ...
                                <div class="col-sm-7 formContainer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group roleContainer"></div>
                                        <div class="col-sm-10 form-group notesContainer"></div>
                                        <div class="col-sm-2 form-group levelContainer" data-toggle="tooltip" style="float: right; max-width: 75px;"></div>
...
(function($) {
    ...
    var preview_btn = $('.btn-pdf-preview')
    var pdf_page_link = "<?php echo site_url('pdf/'); ?>"
            ...
            $.ajax({
                ...
                success: function(response, status, xhr) {
                    if (response.length > 0) {
                        ...
                        // ACTIVATE BUTTONS
                        let previewLink = pdf_page_link + '?pid=' + post_id + '&user_id=' + user_id;
                        publish_btn.attr({'user_id': user_id, 'disabled': false});
                        preview_btn.attr({'href': previewLink, 'disabled': false});
